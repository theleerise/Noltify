...
class DepartmentModel(EntityModel):
    ...
    id: int | None = Field(default=None, title="ID", description="Identificador del departamento")

    code: str = Field(..., title="Código", description="Código único del departamento")
    name: str = Field(..., title="Nombre", description="Nombre del departamento")
