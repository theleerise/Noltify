...
urlpatterns = [
    ...
    path("profile/update/", app_user_views.profile_update_view, name="profile_update"),
    path("profile/deactivate/", app_user_views.profile_deactivate_view, name="profile_deactivate"),
